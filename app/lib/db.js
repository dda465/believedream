...
export const fallbackProducts = [
  { id:"1", name:"LG 듀얼인버터 제습기 20L", brand:"LG", model:"DQ200PGAA", price6:"18,000", price12:"15,000", price24:"13,000", condition:"A급", usedYears:"2년", desc:"사용감 적음, 필터 교체 완료. 20L 대용량으로 넓은 원룸도 커버. 인버터 방식으로 소음 적고 전기세 절약.", store:"빌리드림 직영", area:"직영점", district:"부산진구", todayInstall:true, buyout:true, buyoutPrice:"180,000", onlinePay:true, emoji:"💧", category:"dehumidifier" },
  { id:"2", name:"위닉스 제습기 16L", brand:"위닉스", model:"DN-16LWIE", price6:"12,000", price12:"10,000", price24:"8,500", condition:"B급", usedYears:"3년", desc:"외관 사용감 있으나 기능 이상 없음. 16L 적정 용량.", store:"빌리드림 직영", area:"직영점", district:"부산진구", todayInstall:true, buyout:true, buyoutPrice:"120,000", onlinePay:true, emoji:"💧", category:"dehumidifier" },
  ...
  { id:"4", name:"다이슨 퓨어쿨 공기청정기 TP07", brand:"다이슨", model:"TP07", price6:"27,000", price12:"22,000", price24:"19,000", condition:"S급", usedYears:"1년", desc:"필터 신품 교체. 다이슨 특유의 디자인과 성능.", store:"빌리드림 직영", area:"직영점", district:"부산진구", todayInstall:true, buyout:true, buyoutPrice:"350,000", onlinePay:true, emoji:"🌿", category:"air-purifier" },
  ...
  { id:"7", name:"삼성 그랑데 건조기 9kg", brand:"삼성", model:"DV90T5540BW", price6:"33,000", price12:"28,000", price24:"24,000", condition:"A급", usedYears:"2년", desc:"9kg 대용량. AI 건조 기능. 정상 작동.", store:"빌리드림 직영", area:"직영점", district:"부산진구", todayInstall:true, buyout:true, buyoutPrice:"420,000", onlinePay:true, emoji:"👕", category:"dryer" },
